...
import com.example.grpc.GreeterGrpc.getServiceDescriptor
...
/**
 * Holder for Kotlin coroutine-based client and server APIs for com.example.grpc.Greeter.
 */
object GreeterGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) com.example.grpc.Greeter service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the com.example.grpc.Greeter service based on Kotlin coroutines.
   */
  abstract class GreeterCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for com.example.grpc.Greeter.SayHello.
     *
    ...
    open suspend fun sayHello(request: HelloRequest): HelloReply = throw
        StatusException(UNIMPLEMENTED.withDescription("Method com.example.grpc.Greeter.SayHello is unimplemented"))
